var Qixi = function () {
    ...
    if (confi.audio.enable) {
        var audio1 = Hmlt5Audio(document.getElementById('happy'), false, true);
        var audio2 = Hmlt5Audio(confi.audio.cycleURL, true, false);
        audio1.end(function () {
            audio2.audio.play();
        })
    }
                    ...
                    $('#i5').css({
                        ...
                        function word(index) {
                            if (index < span.length) {
                                $(span[index]).fadeIn(time, function () {
                                    time -= cha;
                                    cha += 25;
                                    word(index + 1);
                                });
                                ...
                                setTimeout(function () {
                                    $('.last').addClass("logolightSpeedIn").on(animationEnd, function () {
                                        var me = $(this);
                                        me.addClass("logoshake").off();
                                    });
                                }, 2000);
    ...
    function Hmlt5Audio(url, loop, autoplay) {
        if (typeof url === 'string') {
            ...
            return {
                    ...
                    url.addEventListener("ended", function () {
                        callback()
                    }, false)
                },
                audio: url
