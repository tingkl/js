 ...
 */
define(['ui.Widget'], 'ui.navigation.Accordian', function (Widget) {
    function Accordian(config) {
        Accordian.superClass.call(this, config);
    }
    Accordian.event = {
        click: 'click'
    };
    ...
    /*Accordian.Config = dc;*/
    ClassManager.extend(Accordian, Widget);
    Accordian.prototype.patchConfig = function (config, children) {
    ...
    Accordian.prototype.initTrigger = function() {
        var that = this;
        $('li', this.root).on('click', function(evt) {
            ...
            that.emit(Accordian.event.click, target);
            evt.stopPropagation();
        });
    }
